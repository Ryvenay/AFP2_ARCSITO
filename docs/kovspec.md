...
=======
A bejelentkezéshez a hallgatóknak névre, neptunkódra és e-mail címre lesz szükségük. A dolgozóknak névre, e-mail címre, szervezeti egység megjelentetésére. Külsősnek pedig a nevére, e-mail címére, lakóhelyük megadására lesz szükségük. Ez után a főoldal jelenik meg a bejelentkezőnek ahol az egyén láthatja a meghirdetett rendezvényeket.
